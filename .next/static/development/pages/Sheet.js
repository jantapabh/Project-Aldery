...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2FSheet&absolutePagePath=C%3A%5CUsers%5CNoeypatt%5CDocuments%5Celdery-project-nextjs%5Cpages%5CSheet.js!./":
/*!************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2FSheet&absolutePagePath=C%3A%5CUsers%5CNoeypatt%5CDocuments%5Celdery-project-nextjs%5Cpages%5CSheet.js ***!
  \************************************************************************************************************************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _components_layout_load__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/layout/load */ "./components/layout/load.js");
...
/*#__PURE__*/
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_7__["default"])(Sheet, _React$Component);

  function Sheet(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Sheet);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5__["default"])(Sheet).call(this, props));
        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                list = _context.sent;
                if (value == '!B1:B') _this.setState({
                  provinceList: list
                });else if (value == '!F1:F') _this.setState({
                  manlist: list
                });else if (value == '!G1:G') _this.setState({
                  womanlist: list
                });else if (value == '!H1:H') _this.setState({
                  totallist: list
                });
                _context.next = 10;
                break;
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Sheet, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return this.list('!B1:B');

              case 4:
                _context2.next = 6;
                return this.list('!F1:F');

              case 6:
                _context2.next = 8;
                return this.list('!G1:G');

              case 8:
                _context2.next = 10;
                return this.list('!H1:H');
    ...
    value: function render() {
      if (this.state.totallist.length < 1) {
        return __jsx("div", null, __jsx(_components_layout_load__WEBPACK_IMPORTED_MODULE_11__["default"], null));
      }

      return __jsx("div", null, __jsx("h1", null, "Hello"), this.state.provinceList.map(function (item, index) {
        return __jsx("div", {
          key: index
        }, item);
      }), this.state.manlist.map(function (item, index) {
        return __jsx("div", {
          key: index
        }, item);
      }), this.state.womanlist.map(function (item, index) {
        return __jsx("div", {
          key: index
        }, item);
      }), this.state.totallist.map(function (item, index) {
        return __jsx("div", {
          key: index
        }, item);
      }));
...
/***/ 3:
/*!****************************************************************************************************************************************************!*\
  !*** multi next-client-pages-loader?page=%2FSheet&absolutePagePath=C%3A%5CUsers%5CNoeypatt%5CDocuments%5Celdery-project-nextjs%5Cpages%5CSheet.js ***!
  \****************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! next-client-pages-loader?page=%2FSheet&absolutePagePath=C%3A%5CUsers%5CNoeypatt%5CDocuments%5Celdery-project-nextjs%5Cpages%5CSheet.js! */"./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2FSheet&absolutePagePath=C%3A%5CUsers%5CNoeypatt%5CDocuments%5Celdery-project-nextjs%5Cpages%5CSheet.js!./");
