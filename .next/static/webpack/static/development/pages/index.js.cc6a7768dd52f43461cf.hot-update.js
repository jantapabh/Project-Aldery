                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          return {
                            name: _this.list[i][0],
                            ชาย60ปีขึ้นไป: _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_2___default()(_this.list[i][1].replace(",", "")),
                            หญิง60ปีขึ้นไป: _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_2___default()(_this.list[i][2].replace(",", ""))
                          };
...
//# sourceMappingURL=index.js.cc6a7768dd52f43461cf.hot-update.js.map