...
const BarHospital3 = () => {
    ...
    const fetchData = async () => {
        ...
        await namelist(userOauth.data.access_token, 'สรุปข้อมูลทางสถิติ!BP8:BP11')
        await listData(userOauth.data.access_token, 'สรุปข้อมูลทางสถิติ!BR8:BR11', 'สรุปข้อมูลทางสถิติ!BS8:BS11')
    }
